...
int main()
{
    ...
    // ------------------------------------
    char* headDir = "/Users/haoxiangliang/Desktop/代码草稿/OpenGL/OpenGL_Test25_Bloom/OpenGL_Test25_Bloom/";
    string p1 = string(headDir) + "LightShader/Bloom.vs";
    string p2 = string(headDir) + "LightShader/Bloom.fs";
    Shader shader(p1.c_str(), p2.c_str());
    string p3 = string(headDir) + "LightShader/LightBox.vs";
    string p4 = string(headDir) + "LightShader/LightBox.fs";
    Shader shaderLight(p3.c_str(), p4.c_str());
    string p5 = string(headDir) + "LightShader/Blur.vs";
    string p6 = string(headDir) + "LightShader/Blur.fs";
    Shader shaderBlur(p5.c_str(), p6.c_str());
    string p7 = string(headDir) + "LightShader/BloomFinal.vs";
    string p8 = string(headDir) + "LightShader/BloomFinal.fs";
    Shader shaderBloomFinal(p7.c_str(), p8.c_str());

    // load textures
    // -------------
    unsigned int woodTexture = loadTexture("/Users/haoxiangliang/Desktop/未命名文件夹/wood.png");
    unsigned int containerTexture = loadTexture("/Users/haoxiangliang/Desktop/未命名文件夹/container2.png");
